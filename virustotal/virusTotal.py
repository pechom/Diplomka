...
class VirusTotal(object):
    def __init__(self):
        self.apikey = "0c4047d034a7f8e0f5afd8884d47af625df14618c8ec5c98ff03d599a8f5441e"
...
if __name__ == "__main__":
    ...
    #     sys.exit()
    vt.apikey = "0c4047d034a7f8e0f5afd8884d47af625df14618c8ec5c98ff03d599a8f5441e"
    ...
    parser.add_argument("-m", "--retrievefrommeta",
                        help="retrieve reports based on checksums in a metafile (one sha256 checksum for each line)",
                        metavar="METAFILE")
...
# for instance python virusTotal.py -v -r C:\CFFExplorer.exe -l C:\virustotal.json